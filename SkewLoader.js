(function (global, factory) {
  ...
  var skew = (0, _core.keyframes)('25%{transform:perspective(100px) rotateX(180deg) rotateY(0)}50%{transform:perspective(100px) rotateX(180deg) rotateY(180deg)}75%{transform:perspective(100px) rotateX(0) rotateY(180deg)}100%{transform:perspective(100px) rotateX(0) rotateY(0)}');
  ...
  var Loader = function (_React$Component) {
    ...
    function Loader() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.style = function () {
        ...
        var style = (0, _core.css)('{width:0;height:0;border-left:', '' + size + sizeUnit, ' solid transparent;border-right:', '' + size + sizeUnit, ' solid transparent;border-bottom:', '' + size + sizeUnit, ' solid ', color, ';display:inline-block;animation:', skew, ' 3s 0s infinite cubic-bezier(.09,.57,.49,.9);animation-fill-mode:both;}');
