(function (global, factory) {
  ...
  var rotate = (0, _core.keyframes)('0%{transform:rotate(0deg)}50%{transform:rotate(180deg)}100%{transform:rotate(360deg)}');
  ...
  var Loader = function (_React$Component) {
    ...
    function Loader() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.style = function (i) {
        return (0, _core.css)('{opacity:0.8;position:absolute;top:0;left:', i % 2 ? -28 : 25, 'px;}');
      }, _this.ball = function () {
        ...
        return (0, _core.css)('{background-color:', color, ';width:', '' + size + sizeUnit, ';height:', '' + size + sizeUnit, ';margin:', margin, ';border-radius:100%;}');
      }, _this.wrapper = function () {
        var wrapper = (0, _core.css)(_this.ball(), ';display:inline-block;position:relative;animation-fill-mode:both;animation:', rotate, ' 1s 0s infinite cubic-bezier(.7,-.13,.22,.86);');

        return _this.props.css ? (0, _core.css)(wrapper, ';', _this.props.css) : wrapper;
      }, _this.long = function () {
        return (0, _core.css)(_this.ball(), ';', _this.style(1), ';');
      }, _this.short = function () {
        return (0, _core.css)(_this.ball(), ';', _this.style(2), ';');
      ...
      value: function render() {
        ...
        return loading ? _react2.default.createElement(
          ...
          _react2.default.createElement('div', {
            className: (0, _emotion.css)(this.long())
          }),
          _react2.default.createElement('div', {
            className: (0, _emotion.css)(this.short())
          })
        ) : null;
      }
    }]);
